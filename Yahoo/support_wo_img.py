...
class RatingDataset(torch.utils.data.Dataset):
    def __init__(self, train_csv, genres, category_num, user_set,  positive_number, negative_number):
    ...
    def __getitem__(self, index):
        ...
        return torch.tensor(user), torch.tensor(item), genres, torch.tensor(neg_user),\
